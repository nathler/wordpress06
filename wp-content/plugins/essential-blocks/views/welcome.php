...
<div class="essential-blocks-welcome-page-wrapper">
	...
	<?php
	echo ESSENTIAL_BLOCKS_ADMIN_URL . 'assets/images/welcome/welcome-banner.png';
	?>
																		)">
	...
	<div class="eb-dashboard-wrapper">
		...
		<a href="<?php echo esc_url_raw( admin_url( 'admin.php?page=essential-blocks' ) ); ?>" class="back-dashboard"><?php esc_attr_e( 'Go To Dashboard', 'essential-blocks' ); ?></a>
	</div>
</div>
